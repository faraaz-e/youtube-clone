  ...
  return (
    <div className="grid grid-flow-col">
      <div className="flex col-span-2 py-2 px-5 items-center">
        ...
        <sup className="text-zinc-400 pl-2">IN</sup>
      </div>

      <div className="col-span-8 flex justify-center py-2">
        <input
          type="text"
          className="py-2 px-4 border border-solid border-zinc-800 bg-black text-zinc-800 focus:border-blue-800 rounded-l-full w-1/2"
          placeholder="Search"
        />

        <button className="py-2 px-5 border border-solid border-zinc-800 bg-zinc-800 hover:bg-zinc-700 rounded-r-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button className="mx-3 p-3 bg-zinc-800 hover:bg-zinc-700 rounded-full text-white hidden md:block">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
